import {subtypeUrl} from './subtype-data.mjs?v=local-batches-2';
...
import {readConfig,normalizeAccession,loadProfile,el} from './common.mjs?v=local-batches-2';
...
const share=v=>v===null||profile.total===null?'Not available':percent(v,profile.total).toFixed(2)+'% of profile';
