...
Before publishing, run `node --test tests/*.test.mjs`. No generated subtype index or data build step is required. The current complete site is approximately 646 MB.
